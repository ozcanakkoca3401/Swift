...
class OAuthViewController: UIViewController, OAuthIODelegate {
    ...
    override func viewDidLoad() {
        ...
        //let key : String = "t5V_SJD4lJWbZuE6fsBD_7p0Vqg"
         let key: String = "Yfbta2IEJTnZZKvFeo3bJofOfD4"
    ...
    @IBAction func LoginClick() {
        ...
        self.oauth_modal?.show(withProvider:"linkedin", options: options as [NSObject : AnyObject])
    }
